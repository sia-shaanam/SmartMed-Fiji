  ...
  <div class="container">
    ...
    <nav class="nav-bar">
      <ul>
        ...
        <li><a href="ehr_main.php"><i class="fas fa-file-medical"></i><span class="nav-item">Patients</span></a></li>
...
<div class="search-section">
    ...
    <button 
        onclick="window.location.href='../reports/generate_patient_pdf.php'" 
