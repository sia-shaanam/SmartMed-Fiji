...
<body>
  <div class="container">
    ...
    <nav class="nav-bar">
      <ul>
        ...
        <li><a href="doc_app_index.php"><i class="fas fa-file-medical"></i><span class="nav-item">Appointments</span></a></li>
  ...
  <div class="patient-card" style="background-color: #003366; color:white;">
    

    <div class="appointments">
        <a href="confirm-appointments.php">
        <button class="message-btn" style="color:white; background-color:  #003366;">Manage Appointments</button>
    </a>
    </div>
</div>
...
<div>
 ...
 <h1 style="padding:10px; font-size:30px;">Doctors Master Appointment Calendar</h1>
    ...
    <div class="section-header">
        ...
        <div class="filters">
            <form method="GET" action="">
                ...
                <button type="button" class="add-appointment" style="color:white; background-color: #003366;">+ Add New Appointment</button></a>
            </form>
        </div>
    </div>
